  ...
  (parser
   ...
   (grammar
    ...
    (statement
     ...
     [(PAPER expr) (paper-expr $2 (numeric-expr DEFAULT-PAPER-SIZE) (numeric-expr DEFAULT-PAPER-SIZE))] ; Added by Lexxi
     [(PAPER expr expr expr) (paper-expr $2 $3 $4)] ; Added by Lexxi

     [(PEN expr) (pen-expr $2)] ; Added by Lexxi

     [(LINE expr expr expr expr) (line-expr $2 $3 $4 $5)] ; Added by Lexxi

     ; These return an assignment-expr
     [(SET l-value expr) (assignment-expr $2 $3)] ; Added by Lexxi
     [(SET IDENTIFIER expr) (assignment-expr $2 $3)] ; Added by Lexxi

     ; This returns a var-exp
     [(REPEAT IDENTIFIER expr expr maybe-newlines block) (repeat-expr $2 $3 $4 $6)] ; Added by Lexxi
     
     
     ; print, simply prints to the console
     [(PRINT expr ) (print-expr $2)]
     ;[(SET l-value expr) (assignment-expr $2 $3)] -- SAME AS ABOVE
     ;[(LINE expr expr expr expr) (line-expr $2 $3 $4 $5)] -- SAME AS ABOVE
    ...
    (l-value
     ...
     [(IDENTIFIER) (var-expr $1)] ; Added by Lexxi
